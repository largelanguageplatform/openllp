...
receipts, and bank statements) is handled by the bundled **[pdf-agent](agents/pdf-agent/)**
...
(see [pdf-agent/README.md](agents/pdf-agent/README.md)). Text-only personas like `tax_noob`

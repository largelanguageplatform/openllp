...
config :platform, :scopes,
  organization: [
    default: true,
    module: Platform.Account.Scope,
    assign_key: :current_scope,
    access_path: [:organization, :id],
    schema_key: :organization_id,
    schema_type: :id,
    schema_table: :organizations,
    test_data_fixture: Platform.AccountFixtures,
    test_setup_helper: :register_and_log_in_organization
  ]
...
config :platform, PlatformWeb.Endpoint,
  ...
  live_view: [signing_salt: "k9lGjROo"]
